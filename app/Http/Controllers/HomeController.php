...
class HomeController extends Controller
{
    ...
    private function getCommonData()
    {
        ...
        return [
            ...
            'testimonials_info' => $settings['testimonials_info'] ?? [
                'tag' => 'آراء العملاء',
                'h3' => 'أفضل شركة عزل أسطح بالقصيم رونق قلب الخليج للعزل الأمريكي بضمان موثق معتمد ١٥ عام',
                'h2' => 'ما هي آراء عملائنا',
                'p' => 'أكثر من 800 عميل راضٍ في القصيم وبريدة وحائل'
            ],
            'areas_info' => $settings['areas_info'] ?? [
                'tag' => 'مناطق الخدمة',
                'h3' => 'أفضل شركة عزل فوم بالقصيم رونق قلب الخليج للعزل الأمريكي بضمان موثق معتمد ١٥ عام',
                'h2' => 'نخدم كل المنطقة',
                'p' => 'نغطي القصيم وبريدة وحائل وكل المناطق المجاورة'
            ],
